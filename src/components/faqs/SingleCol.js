...
export default ({
  ...
  faqs = [
    ...
    {
      question: "Минимальная и максимальная суммы обмена",
      answer:
    ...
    {
      question: "Почему мне на почту не приходят письма о статусе заявки?",
      answer:
    ...
    {
      question: "Могу ли я совершить обмен без создания заявки?",
      answer:
    ...
    {
      question: "Что значит почистите кэш (cache) и куки (cookies)?",
      answer:
    ...
    {
      question: "Могу ли я предложить вам сотрудничество?",
      answer:
