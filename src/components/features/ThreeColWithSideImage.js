...
export default ({ cards = null, heading = "Как начать?", subheading = "Features" }) => {
  /*
  ...
  const defaultCards = [
    ...
    { imageSrc: CustomizeIconImage, 
      ...
      description: "Мы ценим Ваше время. Поэтому всего лишь 3 простых и понятных шага для обмена криптовалюты с помощью нашего сервиса" 
    }
  ];
